                    ...
                    <table class="table">
                        <td>
                            <div class="form-group d-flex align-items-center">
                                ...
                                <input type="text" name="thickness" value="{{$vp->thickness}}" placeholder="Espesor" class="form-control">
                            </div>
                        </td>
                        <td>
                            <div class="form-group d-flex align-items-center">
            ...
            <div class="table-responsive">
                <table class="table">
                    <td>
                        <div class="form-group d-flex align-items-center">
                            <span class="mr-2" style="color: red;">*</span>
                            <input type="text" name="thickness" placeholder="Espesor" class="form-control">
                        </div>
                    </td>
                    <td>
                        <div class="form-group d-flex align-items-center">
